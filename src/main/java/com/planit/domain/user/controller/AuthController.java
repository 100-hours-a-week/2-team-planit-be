...
public class AuthController {
    ...
    @PostConstruct
    void logInjectedAuthServiceBean() {
        String[] beanNames = applicationContext.getBeanNamesForType(AuthService.class);
        log.info("AuthController initialized - injected authServiceClass={}, beanCount={}, beanNames={}",
            authService.getClass().getName(), beanNames.length, String.join(",", beanNames));
    }
    ...
    public LoginResponse login(@Valid @RequestBody LoginRequest request) {
        log.info("AuthController.login called - authServiceClass={}, instanceHash={}",
            authService.getClass().getName(), System.identityHashCode(authService));
